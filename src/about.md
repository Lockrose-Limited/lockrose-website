...
comparisonSection:
  items:
    - title: Common programme challenges
      list:
        items:
          - listItem: Weeks spent finding the right support
          - listItem: Capability assessed on paper
          - listItem: Time spent getting up to speed
          - listItem: Reporting on issues
          - listItem: Delayed decisions
          - listItem: Competing priorities
    - title: How Lockrose responds
      list:
        items:
          - listItem: Faster mobilisation from a trusted network
          - listItem: Proven delivery experience
          - listItem: Quick integration into the programme
          - listItem: Working to solve them
          - listItem: Direct access to experienced judgement
          - listItem: Shared focus on programme outcomes
